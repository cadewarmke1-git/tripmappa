...
import { roadStopToSignCategory } from "../../lib/neonSignCategory.js";
...
export default function RoadStopCard({
  ...
  const categoryLabel = isCharging ? "EV" : (stop.category || "Stop");
