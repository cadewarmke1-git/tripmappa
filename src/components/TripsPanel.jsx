    ...
    <div className="stops-wrap">
      ...
      {savedTrips.length > 0 ? (
          ...
          <div key={trip.id} className="stop-card" style={{ marginBottom: 10 }}>
            <div className="stop-card-head">
              ...
              <div style={{ display: "flex", gap: 6 }}>
                ...
                <button type="button" className="action-btn action-btn-danger" style={{ flex: "none", padding: "4px 10px", fontSize: 11 }} onClick={() => onDeleteTrip(trip.id)}>Delete</button>
              </div>
            </div>
          </div>
        ))
        ...
        <div className="empty-state">
          <div className="empty-icon" aria-hidden="true">TM</div>
