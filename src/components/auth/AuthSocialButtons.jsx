export default function AuthSocialButtons({ onGoogle, onFacebook, onApple, compact = false, disabled = false }) {
  return (
    <div className={`auth-social-btns${compact ? " auth-social-btns-compact" : ""}`}>
      <button type="button" className="auth-social-btn" onClick={onGoogle} disabled={disabled}>
      ...
      <button type="button" className="auth-social-btn" onClick={onFacebook} disabled={disabled}>
      ...
      <button type="button" className="auth-social-btn" onClick={onApple} disabled={disabled}>
